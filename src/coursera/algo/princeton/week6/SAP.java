package coursera.algo.princeton.week6;
...
public class SAP {
    ...
    private final Digraph copyG;            // save the copy of associated digraph
    ...
    private final Stack<Integer> stack1;    // store changed auxiliary array1 entries
    private final Stack<Integer> stack2;    // store changed auxiliary array1 entries
    ...
    private void validateVertex(int v) {
        int w = marked1.length;
        if (v < 0 || v >= w)
            throw new IllegalArgumentException("vertex " + v + " is not between 0 and " + (w - 1));
    }
